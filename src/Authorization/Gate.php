...
namespace Fluent\Auth\Authorization;

use Closure;
use CodeIgniter\Events\Events;
use Exception;
use Fluent\Auth\Authorization\Events\GateEvaluated;
use Fluent\Auth\Contracts\GateInterface;
use Fluent\Auth\Exceptions\AuthorizationException;
...
class Gate implements GateInterface
{
     ...
     *
     * @param  \Fluent\Auth\Authorization\Response|\Closure|bool  $condition
     ...
     *
     * @param  \Fluent\Auth\Contracts\AuthenticatorInterface|null  $user
