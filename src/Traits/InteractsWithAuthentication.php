...
trait InteractsWithAuthentication
{
     ...
     * @return $this
     */
    public function actingAs(AuthenticatorInterface $user, $guard = null)
    {
     ...
     * @return $this
     */
    public function be(AuthenticatorInterface $user, $guard = null)
    {
    ...
    {
        $expected = auth()->guard($guard)->user();
        ...
        $this->assertSame(
            $expected->getAuthId(), $user->getAuthId(),
            'The currently authenticated user is not who was expected'
        );
